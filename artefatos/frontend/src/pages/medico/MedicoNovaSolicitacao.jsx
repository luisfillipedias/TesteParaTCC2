        ...
        <div className="card animate-fade-in-up">
          ...
          <div className="card-body">
            <form>
              ...
              <div className="form-row"><div className="form-group"><label className="form-label">Paciente <span className="required">*</span></label><input type="text" className="form-control" placeholder="Nome ou CPF" defaultValue="Maria da Silva" /></div><div className="form-group"><label className="form-label">Cartão SUS</label><input type="text" className="form-control" placeholder="Nº do CNS" defaultValue="898 0012 3456 7890" /></div></div>
              <div className="form-group"><label className="form-label">Procedimento / Especialidade <span className="required">*</span></label><select className="form-control form-select"><option>Consulta Cardiologia</option><option>Cirurgia Ortopédica</option><option>Ressonância Magnética</option><option>Tomografia</option><option>Consulta Neurologia</option><option>Exame Laboratorial</option></select></div>
              <div className="form-row"><div className="form-group"><label className="form-label">Prioridade <span className="required">*</span></label><select className="form-control form-select"><option>Alta — Urgência</option><option>Média — Necessário</option><option>Baixa — Eletivo</option></select></div><div className="form-group"><label className="form-label">Unidade de Destino</label><select className="form-control form-select"><option>Hospital Regional de BH</option><option>Hospital Estadual</option><option>Clínica São Lucas</option><option>UPA Norte</option></select></div></div>
              <div className="form-row"><div className="form-group"><label className="form-label">CID-10</label><input type="text" className="form-control" placeholder="Ex: I25.1" defaultValue="I25.1" /></div><div className="form-group"><label className="form-label">Data Preferencial</label><input type="date" className="form-control" defaultValue="2026-05-10" /></div></div>
              <div className="form-group"><label className="form-label">Justificativa Clínica <span className="required">*</span></label><textarea className="form-control" rows="4" defaultValue="Paciente com quadro de dor torácica recorrente, ECG alterado. Necessita avaliação cardiológica especializada para definição de conduta terapêutica."></textarea></div>
              ...
              <div style={{display:'flex',gap:'var(--space-3)',justifyContent:'flex-end',marginTop:'var(--space-4)'}}>
                <button type="button" className="btn btn-secondary" onClick={() => history.back()}>Cancelar</button>
                <button type="submit" className="btn btn-primary btn-lg" onClick={(e) => { e.preventDefault(); alert('Solicitação enviada com sucesso!'); }}><i className="fa-solid fa-paper-plane"></i> Enviar Solicitação</button>
              </div>
            </form>
          </div>
        </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div style={{textAlign:'center',marginBottom:'var(--space-4)'}}>
                <div style={{width:56,height:56,borderRadius:'var(--radius-full)',background:'var(--grad-primary)',color:'#fff',display:'flex',alignItems:'center',justifyContent:'center',margin:'0 auto var(--space-3)',fontWeight:700,fontSize:'var(--text-lg)'}}>MS</div>
                <div style={{fontWeight:700}}>Maria da Silva</div>
                <div style={{fontSize:'var(--text-xs)',color:'var(--clr-text-secondary)'}}>CPF: ***.456.789-01</div>
              </div>
              <div style={{fontSize:'var(--text-xs)',color:'var(--clr-text-secondary)',display:'flex',flexDirection:'column',gap:'var(--space-2)'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between'}}><span>Solicitações ativas:</span><strong style={{color:'var(--clr-text)'}}>2</strong></div>
              </div>
            </div>
          </div>
        </div>
